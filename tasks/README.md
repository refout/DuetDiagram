...
Phase 1 已落地 P1-01 ~ P1-08、P1-11 ~ P1-13、P1-15、P1-16、P1-18；
P1-09 / P1-10（Mermaid 导入导出）、P1-14（对比评分）、
P1-17（DSL 语义映射）已写好任务文件待做。

**P1-14 只做了一半，是刻意的。** 装置（盲评清单 + 解析统计）已落地，
结论那一半留空——检查项判不了机器，三个指标要真人评分。
见 `reports/compare-blind/conclusion.md` 与那个 YAML 的 `progress` 块。
