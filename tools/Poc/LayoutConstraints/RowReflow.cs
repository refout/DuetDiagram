...
{
    /// <summary>层内节点之间保留的间隙。</summary>
    private const double Gap = 36;

    public static ReflowResult Apply(PlacedNode[] nodes, IReadOnlySet<string> anchored, bool ranksAreVertical)
    {
        ...
        var reflowed = ReflowVertical(working, anchored);
    ...
    private static ReflowResult ReflowVertical(PlacedNode[] nodes, IReadOnlySet<string> anchored)
    {
